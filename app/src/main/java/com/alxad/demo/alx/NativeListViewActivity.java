...
public class NativeListViewActivity extends AppCompatActivity {
    ...
    private void loadAd() {
        AlxNativeAdLoader loader = new AlxNativeAdLoader.Builder(this, AdConfig.ALX_NATIVE_AD_PID).build();
    ...
    private class MyAdapter extends BaseAdapter {
        ...
        private View getNormalView(View convertView, ViewGroup parent, int position) {
            ...
            holder.mTvTitle.setText(getString(R.string.list_item_native_title)+":  " + position);
            holder.mTvDesc.setText(getString(R.string.list_item_native_desc)+":  " + position);
            return convertView;
        }
