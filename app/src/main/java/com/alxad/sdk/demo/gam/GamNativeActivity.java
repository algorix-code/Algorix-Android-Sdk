...
public class GamNativeActivity extends BaseActivity implements View.OnClickListener {
    private final String TAG = "GamNativeActivity";
    ...
    private void loadAd() {
        ...
        mAdLoader = new AdLoader.Builder(this, AdConfig.GAM_NATIVE_ID)
                ...
                .build();
        mAdLoader.loadAd(new AdManagerAdRequest.Builder().build());
    }
