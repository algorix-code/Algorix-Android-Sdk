package com.test.alxad.demo.toponad;
...
public class TopOnVideoDemoActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void initView() {
        ...
        mVideoAD = new ATRewardVideoAd(this, AppConfig.mVideoAdPID_TOPON);
        mVideoAD.setAdListener(new ATRewardVideoExListener() {
            ...
            public void onRewardedVideoAdFailed(AdError errorCode) {
                Log.i(TAG, "视频广告加载错误 " + errorCode.getCode() + " " + errorCode.getDesc());
                runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
